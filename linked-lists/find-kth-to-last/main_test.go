...
func TestFindKthToLast_Attempt1(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "Test Case 2", args: args{sll: *list.NewSinglyLinkedList(1, 1), k: 2}, want: 1},
		{name: "Test Case 3", args: args{sll: *list.NewSinglyLinkedList(1, 2, 3, 4, 1, 5, 6), k: 5}, want: 1},
	}
